...
public class CompensationApplication {
        public static void main(String[] args) {
                ...
                while (running) {
                        ...
                        int choice = dashboard.getChoice();
                        ...
                        switch (choice) {
                                ...
                                case 4 -> deleteEmployee(dashboard, employeeService);

                                case 5 -> dashboard.displayAnalytics(employeeService.getAnalyticsReport());

                                case 6 -> dashboard.displayPayrollSummary(employeeService.getPayrollSummary());
        ...
        private static void registerEmployee(ConsoleDashboard dashboard, EmployeeService employeeService) {
                try {

                        int employeeId = dashboard.readEmployeeId();
                        ...
                        if (employeeService.employeeExists(employeeId)) {
                                ...
                                String name = dashboard.readEmployeeName();

                                String department = dashboard.readDepartment();

                                double salary = dashboard.readSalary();

                                int experience = dashboard.readExperienceYears();
        ...
        private static void viewEmployees(ConsoleDashboard dashboard, EmployeeService employeeService) {

                dashboard.displayEmployees(
        ...
        private static void searchEmployee(ConsoleDashboard dashboard, EmployeeService employeeService) {

                int employeeId = dashboard.readSearchEmployeeId();

                employeeService.findEmployeeById(employeeId)

                                .ifPresentOrElse(

                                                dashboard::displayEmployee,
        ...
        private static void deleteEmployee(ConsoleDashboard dashboard, EmployeeService employeeService) {

                int employeeId = dashboard.readSearchEmployeeId();

                if (!dashboard.confirmDeletion()) {
        ...
        // double averageSalary = CompensationCalculator.calculateAverageBonus(bonus1,
        // bonus2, bonus3, bonus4,
        // bonus5);
        ...
        // Employee.SalaryBand juniorBand = new Employee.SalaryBand("Junior", 30000,
        // 50000);
        // Employee.SalaryBand seniorBand = new Employee.SalaryBand("Senior", 60000,
        // 100000);
        ...
        // CompensationAnalytics analytics = new
        // CompensationAnalytics(repository.findAll());
